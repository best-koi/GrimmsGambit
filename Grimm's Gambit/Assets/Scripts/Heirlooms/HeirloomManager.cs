...
{
    Hamelin=0, //Flute of Hamelin - Plus 1 Maximum Spirit and Spirit gain on turn start
    Carnation=1, //Pink Carnation - Applies an additional debuff when applying debuffs - currently implemented in the minion.AddAffix 2/2/25
    Jar=2, //Greedy Jar - At the start of combat, draw 2 more cards
    Silk=3, //Faded Gold Silk - The first played card for a party member costs 0 in a combat
    Blindfold=4, //Bloody Blindfold - Enemy Intents are hidden
    Miracle=5, //Miracle Water - One time use that nullifies the hit which would deal fatal damage to a party member 
    Lycan=6, //Lycan's Fang - Scratch cards now deal 2 more damage and apply 1 more bleed - Implemented in ScratchEffect.cs 2/2/25
    Serpent=7, //Serpent Ring - Gain 1 Strength this combat if the Hound has given at least 12 Block in a turn
    Sweater=8 //Durable Sweater - The Seamstress gains 4 Block at the end of a turn
}
